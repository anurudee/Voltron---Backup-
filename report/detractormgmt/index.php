...
<div id="navDemo" class="w3-bar-block w3-black w3-hide w3-hide-large w3-hide-medium w3-top" style="margin-top:59px">
 ...
 <!--  <a href="https://voltron.cisco.com/amp/" class="w3-bar-item w3-button w3-padding-large">Voltron 2</a>  -->
  ...
  <a href="https://voltron.cisco.com/Voltron/" class="w3-bar-item w3-button w3-padding-large" >Logout</a>  
</div>
...
<h2><a class="f1a">D</a><a class="f2a">etractors</a></h2>
<a class="timer">
<?php
$hostname="localhost";
$username="anurudee";
...
$query = "SELECT * , TIME_FORMAT(TIMEDIFF(dateposted,strtime),'%H:%i:%s') AS comp FROM form WHERE cusen ='Unsatisfied' OR cusen ='Very_Unsatisfied' AND us_name !='' ORDER BY c_date DESC LIMIT $start_from, $per_page";
...
<td class="wrap"><span><a style="text-decoration: none; color: #004BB0;" href="http://mwz.cisco.com/<?php echo $row['srnum']; ?>" target="_blank"><?php echo $row['srnum']; ?></a></span></td>
<td class="wrap"><span><?php echo $row['dateposted']; ?></span></td>
<td class="wrap"><span><?php echo $row['comp']; ?></span></td>
<!-- <td style="Text-align:center;" class="wrap"><span><?php echo $row['product']; ?></span></td> -->
