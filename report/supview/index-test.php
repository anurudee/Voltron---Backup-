...
<div class="w3-top">
  <div class="w3-bar w3-black w3-card">
    ...
    <a href="https://voltron.cisco.com/amp/frametest.php" class="w3-bar-item w3-button w3-padding-large"><img class="vlogo" src="https://voltron.cisco.com/amp/img/logo.png" /></a>
...
<button id="excel" onclick="generateExcel()"><img id="excelicon" src="https://www.shareicon.net/data/2016/06/24/618244_excel_2000x2000.png" /></button>	  
...
function generateExcel() {
    ...
    a.download = 'AMP_For_Endpoint_live_cases.xls';
    a.click();
}
...
function generateExcel1() {
    //getting data from our table
    var data_type = 'data:application/vnd.ms-excel';
    var table_div = document.getElementById('table_with_data1');
    var table_html = table_div.outerHTML.replace(/ /g, '%20');
    var a = document.createElement('a');
    a.href = data_type + ', ' + table_html;
...
<iframe style="border:none;width:104%;height: 583px;margin: -16px 0px -10px -36px;" scrolling="no"  src="https://voltron.cisco.com/amp/report/supview/overallreport.php"></iframe>
</div>

<div hidden class="table-responsive">
<?php
$con = mysqli_connect('localhost','anurudee','ironport','ciscoamp_db');
$query = "SELECT * , TIME_FORMAT(TIMEDIFF(dateposted,strtime),'%H:%i:%s') AS comp FROM form WHERE cusen !='' AND us_name !='' AND test_text !='test' AND test_text !='Select Your Issue' ORDER BY id DESC";
$result = mysqli_query ($con, $query);
?>
<table id="table_with_data10" class="table table-bordered table-hover">
<thead>
<tr align="center">
<th>SR.NO</th> 
<th>SR Number</th>
...
<hr>
<button style="margin-top: -0.5%;" id="excel" onclick="generateExcel1()"><img id="excelicon" src="https://www.shareicon.net/data/2016/06/24/618244_excel_2000x2000.png" /></button>	  
<div class="w3-round w3-margin-bottom">
...
<iframe style="border:none;width:104%;height: 583px;margin: -16px 0px -10px -36px;" scrolling="no"  src="https://voltron.cisco.com/amp/report/supview/detractor.php"></iframe>
</div>
</div>
</div>
</div>
