...
document.querySelector("button").addEventListener("click", function () {
	...
	export_table_to_csv(html, "AMP_Overall_Report.csv");
});
...
$query = "SELECT * , TIME_FORMAT(TIMEDIFF(dateposted,strtime),'%H:%i:%s') AS comp FROM form WHERE us_name !='' AND test_text !='test' AND test_text !='Select Your Issue' ORDER BY id DESC";
...
<a download="AMP_Overall_Report.csv" href="blob:https://fiddle.jshell.net/80c9d0a8-2ab7-420f-8eff-a510703ae728" style="display: none;"></a>
</body>
</html>